...
public class NetworkSessionManager : NetworkBehaviour
{
    ...
    public NetworkList<bool> isPlayerAlive = new NetworkList<bool>(
            new List<bool>{true, true, true},
            NetworkVariableReadPermission.Everyone,
            NetworkVariableWritePermission.Server
        );
    public NetworkList<int> insteadPlayer = new NetworkList<int>(
            new List<int>{0, 1, 2},
            NetworkVariableReadPermission.Everyone,
            NetworkVariableWritePermission.Server
        );
    public NetworkList<float> insteadPlayerMagnification = new NetworkList<float>(
